{{-- resources/views/user/kids.blade.php --}}
<x-app-layout>
  <div class="bg-white min-h-screen">
    ...
    <section class="relative">
      <div class="h-[40vh] md:h-[52vh] bg-cover bg-center"
           style="background-image:url('{{ \Storage::url('products/kidsbg.jpg') }}')">
        ...
        @forelse(($products ?? collect()) as $p)
          ...
          <a href="{{ route('user.product.preview', $p->product_id) }}"
            ...
            <div class="pt-3">
              ...
              <div class="text-xs text-gray-500 mt-1">Kids’ Sneakers</div>
            </div>
          </a>
        @empty
  ...
  {{-- Reuse the same tiny Alpine component --}}
  <script>
