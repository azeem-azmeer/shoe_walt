      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <aside class="lg:col-span-4">
          <div class="sticky top-6">
            <div class="border rounded-2xl p-4 sm:p-5 bg-white shadow">
              <h3 class="text-lg font-black mb-3">Order Summary</h3>

              {{-- Scrollable item list --}}
              <div class="space-y-3 mb-4 max-h-[50vh] overflow-y-auto pr-2">
                @foreach($items as $it)
                  <div class="flex gap-3">
                    <div class="h-16 w-16 rounded-md overflow-hidden bg-gray-50 border flex-shrink-0">
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="text-xs text-gray-500">Size: {{ $it['size'] }} · Qty: {{ $it['qty'] }}</div>
                    </div>
              ...
              <dl class="text-sm space-y-2">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <dd class="text-emerald-700 font-semibold">
