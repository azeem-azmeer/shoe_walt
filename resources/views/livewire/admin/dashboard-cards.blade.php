<div wire:poll.60s>
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    {{-- Total Products --}}
    <a href="{{ route('admin.products') }}" class="group relative rounded-2xl p-[1px] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 shadow-lg hover:shadow-xl transition">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <div class="mt-1 text-3xl sm:text-4xl font-extrabold tracking-tight">{{ number_format($totalProducts) }}</div>
            </div>
          </div>
          <div class="opacity-0 group-hover:opacity-100 text-indigo-600/70 text-xs font-semibold transition">View →</div>
        </div>
      </div>
    </a>

    {{-- Men Products --}}
    <a href="{{ route('admin.products') }}" class="group relative rounded-2xl p-[1px] bg-gradient-to-r from-sky-500 to-indigo-500 shadow-lg hover:shadow-xl transition">
      <div class="rounded-2xl bg-white p-5 h-full">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <div class="mt-1 text-3xl sm:text-4xl font-extrabold tracking-tight">{{ number_format($menProducts) }}</div>
          </div>
        </div>
      </div>
    </a>
    ...
    {{-- Women Products --}}
    <a href="{{ route('admin.products') }}" class="group relative rounded-2xl p-[1px] bg-gradient-to-r from-rose-500 to-pink-500 shadow-lg hover:shadow-xl transition">
      <div class="rounded-2xl bg-white p-5 h-full">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <div class="mt-1 text-3xl sm:text-4xl font-extrabold tracking-tight">{{ number_format($womenProducts) }}</div>
          </div>
        </div>
      </div>
    </a>
    ...
    {{-- Kids Products --}}
    <a href="{{ route('admin.products') }}" class="group relative rounded-2xl p-[1px] bg-gradient-to-r from-amber-400 to-orange-500 shadow-lg hover:shadow-xl transition">
      <div class="rounded-2xl bg-white p-5 h-full">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <div class="mt-1 text-3xl sm:text-4xl font-extrabold tracking-tight">{{ number_format($kidsProducts) }}</div>
          </div>
        </div>
      </div>
    </a>
    ...
    {{-- Total Orders --}}
    <a href="{{ route('admin.orders') }}" class="group relative rounded-2xl p-[1px] bg-gradient-to-r from-violet-500 to-indigo-600 shadow-lg hover:shadow-xl transition">
      <div class="rounded-2xl bg-white p-5 h-full">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <div class="mt-1 text-3xl sm:text-4xl font-extrabold tracking-tight">{{ number_format($totalOrders) }}</div>
            </div>
          </div>
          <div class="opacity-0 group-hover:opacity-100 text-violet-600/70 text-xs font-semibold transition">Manage →</div>
        </div>
      </div>
    </a>
    ...
    <div class="group relative rounded-2xl p-[1px] bg-gradient-to-r from-emerald-500 to-teal-500 shadow-lg hover:shadow-xl transition">
      <div class="rounded-2xl bg-white p-5 h-full">
        <div class="flex items-center justify-between">
          ...
          <div class="opacity-0 group-hover:opacity-100 text-emerald-600/70 text-xs font-semibold transition">Nice! ✨</div>
        </div>
      </div>
    </div>
